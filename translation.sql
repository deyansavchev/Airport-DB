...
-- Този файл ще се използва само ако измисля добър начин да се превеждат градовете и да мога да ги търся и на български без грешка, за момента получавам грешки и търсенето не се случва
